...
public class LevelHandler {
    ...
    {
        string clue = 
            "I might add more if I think of some but you need to solve this: Those without wings wish that they might, But always keep away from the light,For it might forever end your flight,And one man ignored this write,Who could it be, stuck in this plight? THREATEN WHEY SKIES."
